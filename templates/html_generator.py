    ...
    <div id="tab-commands" class="tab-content">
        <div class="tab-header">
            ...
            <div class="os-selector">
                <button class="os-btn {'active' if os_type == 'Windows' else ''}" data-os="windows" onclick="selectOS('windows')">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801"/>
                    </svg>
                    Windows
                </button>
                <button class="os-btn {'active' if os_type == 'Linux' else ''}" data-os="linux" onclick="selectOS('linux')">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                    </svg>
                    Linux
                </button>
                <button class="os-btn {'active' if os_type == 'macOS' else ''}" data-os="macos" onclick="selectOS('macos')">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
